<x-app-layout>
    <div 
        ...
        <header class="entry-header flex items-center">
            <h1 class="app-title">Thương hiệu</h1>
        ...
        <div class="entry-content">
            ...
            <div 
                ...
                <div class="add-brand w-96 m-4 p-8 bg-white rounded border border-gray-300 drop-shadow-2xl">
                    <h2 class="font-bold font-xl">Thêm thương hiệu</h2>
            ...
            <div class="list-catagories my-8 p-4 min-h-96 bg-white rounded">
                <h2 class="font-bold">Danh sách thương hiệu</h2>
