<aside class="sticky top-0 bg-slate-800 text-slate-300" aria-label="Sidebar">
    <div class="sticky top-0">
        <header class="flex py-4 px-8 h-18 bg-slate-800 items-center">
            <div class="w-full flex gap-4 justify-center">
                <svg width="1.875em" height="1.5em" viewBox="0 0 250 196" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="py-4 px-4">
        <nav>
            <ul class="ps nav-items ps--active-y">
                <li class="nav-item">
                    <div class="nav-group-label">
                        ...
                        <span class="nav-item-title">Dashboards</span>
                        <span class="nav-item-badge bg-error">New</span>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            aria-hidden="true" role="img" tag="i"
                            class="v-icon notranslate v-theme--light v-icon--size-default nav-group-arrow iconify iconify--mdi"
                            width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <ul class="nav-group-children">
                        <li class="nav-item">
                            <a href="/materio-vuetify-vuejs-laravel-admin-template/demo-1/dashboards/crm" class="">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" tag="i"
                                    class="v-icon notranslate v-theme--light v-icon--size-default nav-item-icon iconify iconify--mdi"
                                    width="1em" height="1em" viewBox="0 0 24 24">
                                ...
                                <span class="nav-item-title">CRM</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/materio-vuetify-vuejs-laravel-admin-template/demo-1/dashboards/analytics" class="">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" tag="i"
                                    class="v-icon notranslate v-theme--light v-icon--size-default nav-item-icon iconify iconify--mdi"
                                    width="1em" height="1em" viewBox="0 0 24 24">
                        ...
                        <li class="nav-item">
                            <a href="/materio-vuetify-vuejs-laravel-admin-template/demo-1/dashboards/ecommerce" class="">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" tag="i"
                                    class="v-icon notranslate v-theme--light v-icon--size-default nav-item-icon iconify iconify--mdi"
                                    width="1em" height="1em" viewBox="0 0 24 24">
                                ...
                                <span class="nav-item-title">eCommerce</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <div class="nav-title-group text-gray-500 font-bold">
                        <span>Apps &amp; Pages</span>
                    </div>
                </li>
                <li class="nav-item">
                    <a href="/materio-vuetify-vuejs-laravel-admin-template/demo-1/apps/email" class="">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            aria-hidden="true" role="img" tag="i"
                            class="v-icon notranslate v-theme--light v-icon--size-default nav-item-icon iconify iconify--mdi"
                            width="1em" height="1em" viewBox="0 0 24 24">
                        ...
                        <span class="nav-item-title">Email</span>
                    </a>
                </li>
                ...
                <div class="ps__rail-y" style="top: 0px; height: 863px; right: 2px;">
                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 600px;">
                    </div>
                </div>
            </ul>
        </nav>
