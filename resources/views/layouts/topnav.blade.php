<nav x-data="{ open: false }" class="sticky top-0 flex items-center p-4 h-18
            bg-white text-slate-700 shadow-md">
    <div class="wrapper w-full flex flex-row justify-between">
        <div class="flex gap-4 items-center">
            ...
            <div class="">
                <input class="h-8 px-4 border-0 rounded-2xl
                                bg-gray-100 text-gray-300 text-md" type="text" name="search" placeholder="Search..." />
            </div>
